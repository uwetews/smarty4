 ...
 * @author  Rodney Rehm
 *
 * @param \Smarty_Compiler_CompilerCore|\Smarty_Compiler_Php_Compiler $compiler compiler object
...
function smarty_modifiercompiler_unescape(Smarty_Compiler_Php_Compiler $compiler, $input, $esc_type = 'html', $char_set = 'null')
{
