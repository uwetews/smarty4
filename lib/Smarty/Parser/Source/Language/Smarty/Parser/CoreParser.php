...
class CoreParser extends PegParser
{
    ...
    /**
     *
     * Parser generated on 2014-07-13 07:30:26
     *  Rule filename 'C:\wamp\www\smarty4\lib\Smarty/Parser/Source/Language/Smarty/Parser/Core.peg.inc' dated 2014-07-13 07:30:26
     *
    */
                            ...
                            public function matchNodeCoreTag($previous, &$errorResult){
                                ...
                                do {
                                    ...
                                    public function CoreTag_EXP_SmartyTag (&$result) {
                                        $result['_text'] = '';
                                        $r = $this->parser->tagDispatcher($result);
                                        return $r;
                                    }
