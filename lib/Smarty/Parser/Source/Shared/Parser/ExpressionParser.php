...
class ExpressionParser extends PegParser
{
    ...
    /**
     * Parser generated on 2014-08-16 15:19:44
     *  Rule filename 'C:\wamp\www\smarty4\lib\Smarty/Parser/Source/Shared/Parser/Expression.peg.inc' dated 2014-08-16 15:19:44
    ...
    {
        $result['node'] = new Number($this->parser);
        $result['node']->setValue($result['_text'])
                       ->setTraceInfo($result['_lineno'], $result['_text'], $result['_startpos'], $result['_endpos']);
    }
    ...
    {
        $result['node'] = new Number($this->parser);
        $result['node']->setValue($subres['_text'])
