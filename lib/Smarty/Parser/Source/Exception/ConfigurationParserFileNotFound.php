 ...
 * @package Smarty\Exception
 */
class Smarty_Source_Exception_ConfigurationParserFileNotFound extends Smarty_Exception_ForSourceLanguage
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct("Source Configuration: Parser file '{$parserFile}' not found", $code, $context);
    }
}
